...
--Q.2 Write a SQL query to retrive all transactions where the category is 'clothing' amd the Quantity sold is more than 4 in the month of Nov-2022
SELECT *
FROM retail_sales
...
ORDER BY 1
--Q.7 WRite a SQL Query to calculate avg sale for each month. Find out best selling month in each year
